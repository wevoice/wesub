...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'KalturaAccount', fields ['type', 'owner_id']
        db.create_unique('externalsites_kalturaaccount', ['type', 'owner_id'])
        ...
        db.create_table('externalsites_brightcoveaccount', (
            ...
            ('import_feed', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['videos.VideoFeed'], unique=True, null=True, on_delete=models.SET_NULL)),
        ))
        db.send_create_signal('externalsites', ['BrightcoveAccount'])

        # Adding unique constraint on 'BrightcoveAccount', fields ['type', 'owner_id']
        db.create_unique('externalsites_brightcoveaccount', ['type', 'owner_id'])
        ...
        db.create_table('externalsites_youtubeaccount', (
            ...
            ('last_import_video_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('import_team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], null=True, blank=True)),
            ('enable_language_mapping', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('externalsites', ['YouTubeAccount'])

        # Adding unique constraint on 'YouTubeAccount', fields ['type', 'owner_id', 'channel_id']
        db.create_unique('externalsites_youtubeaccount', ['type', 'owner_id', 'channel_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'YouTubeAccount', fields ['type', 'owner_id', 'channel_id']
        db.delete_unique('externalsites_youtubeaccount', ['type', 'owner_id', 'channel_id'])

        # Removing unique constraint on 'BrightcoveAccount', fields ['type', 'owner_id']
        db.delete_unique('externalsites_brightcoveaccount', ['type', 'owner_id'])

        # Removing unique constraint on 'KalturaAccount', fields ['type', 'owner_id']
        db.delete_unique('externalsites_kalturaaccount', ['type', 'owner_id'])
