...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TeamNotificationSettings'
        db.create_table('notifications_teamnotificationsettings', (
        ...
        db.send_create_signal('notifications', ['TeamNotificationSettings'])

        # Adding model 'TeamNotification'
        db.create_table('notifications_teamnotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'])),
            ('number', self.gf('django.db.models.fields.IntegerField')()),
            ('data', self.gf('django.db.models.fields.CharField')(max_length=5120)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=512)),
        ...
        db.send_create_signal('notifications', ['TeamNotification'])

        # Adding unique constraint on 'TeamNotification', fields ['team', 'number']
        db.create_unique('notifications_teamnotification', ['team_id', 'number'])

    def backwards(self, orm):
        # Removing unique constraint on 'TeamNotification', fields ['team', 'number']
        db.delete_unique('notifications_teamnotification', ['team_id', 'number'])

        # Deleting model 'TeamNotificationSettings'
        db.delete_table('notifications_teamnotificationsettings')

        # Deleting model 'TeamNotification'
        db.delete_table('notifications_teamnotification')
