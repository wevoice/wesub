...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('widget_subtitlingsession', (
            ...
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subtitling_sessions', to=orm['subtitles.SubtitleLanguage'])),
            ('base_language', self.gf('django.db.models.fields.related.ForeignKey')(related_name='based_subtitling_sessions', null=True, to=orm['subtitles.SubtitleLanguage'])),
            ('parent_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleVersion'], null=True)),
