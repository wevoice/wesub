...
LANGUAGE_NAMES = (
    ...
    ('run', _(u'Kirundi'), u'Kirundi'),
    ('tlh', _(u'Klingon'), u'tlhIngan-Hol'),
    ('ko', _(u'Korean'), u'한국어'),
    ...
    ('tsn', _(u'Setswana'), u'Setswana'),
    ('sna', _(u'Shona'), u'chiShona'),
    ...
    ('som', _(u'Somali'), u'Soomaaliga'),
    ('sot', _(u'Southern Sotho'), u'seSotho'),
    ('es', _(u'Spanish'), u'Español'),
    ('su', _(u'Sundanese'), u'Basa Sunda'),
    ('swa', _(u'Swahili'), u'Kiswahili'),
    ...
    ('fy-nl', _(u'West Frisian'), u'Frysk'),
    ('wol', _(u'Wolof'), u'Wollof'),
    ('xho', _(u'Xhosan'), u'isiXhosa'),
    ('yi', _(u'Yiddish'), u'ייִדיש'),
    ('yor', _(u'Yoruba'), u'Yorùbá'),
    ('za', _(u'Zhuang'), u'Cuengh'),
    ('zul', _(u'Zulu'), u'isiZulu'),
)
