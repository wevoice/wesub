...
urlpatterns = patterns('',
    ...
    url(r'^enterprise/$', 'django.views.generic.simple.direct_to_template',
        {'template': 'enterprise/index.html'}, 'enterprise_page'),
    ...
    url(r'^enterprise/universities/$', 'django.views.generic.simple.direct_to_template',
        {'template': 'enterprise/universities.html'}, 'enterprise_universities'),
