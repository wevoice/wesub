...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SyncHistory.retry'
        db.add_column('externalsites_synchistory', 'retry',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SyncHistory.retry'
        db.delete_column('externalsites_synchistory', 'retry')
