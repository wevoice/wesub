...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CreditedVideoUrl'
        db.create_table('externalsites_creditedvideourl', (
            ('video_url', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.VideoUrl'], primary_key=True)),
        ))
        db.send_create_signal('externalsites', ['CreditedVideoUrl'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'CreditedVideoUrl'
        db.delete_table('externalsites_creditedvideourl')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 17, 13, 8, 53, 214082)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 17, 13, 8, 53, 213943)'}),
