...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'YouTubeAccount.import_feed'
        db.delete_column('externalsites_youtubeaccount', 'import_feed_id')

    def backwards(self, orm):
        # Adding field 'YouTubeAccount.import_feed'
        db.add_column('externalsites_youtubeaccount', 'import_feed',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['videos.VideoFeed'], unique=True, null=True, on_delete=models.SET_NULL),
                      keep_default=False)
