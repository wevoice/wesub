...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'KalturaAccount'
        db.create_table('externalsites_kalturaaccount', (
            ('secret', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('partner_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('team', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['teams.Team'], unique=True)),
        ))
        db.send_create_signal('externalsites', ['KalturaAccount'])

        # Adding model 'SyncedSubtitleVersion'
        db.create_table('externalsites_syncedsubtitleversion', (
            ('account_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('video_url', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.VideoUrl'])),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleLanguage'])),
            ('version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleVersion'])),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('externalsites', ['SyncedSubtitleVersion'])

        # Adding unique constraint on 'SyncedSubtitleVersion', fields ['account_type', 'account_id', 'video_url', 'language']
        db.create_unique('externalsites_syncedsubtitleversion', ['account_type', 'account_id', 'video_url_id', 'language_id'])

        # Adding model 'SyncHistory'
        db.create_table('externalsites_synchistory', (
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('account_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('video_url', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.VideoUrl'])),
            ('language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleLanguage'])),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')()),
            ('version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleVersion'], null=True, blank=True)),
            ('details', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ('action', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('account_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('externalsites', ['SyncHistory'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'KalturaAccount'
        db.delete_table('externalsites_kalturaaccount')

        # Deleting model 'SyncedSubtitleVersion'
        db.delete_table('externalsites_syncedsubtitleversion')

        # Removing unique constraint on 'SyncedSubtitleVersion', fields ['account_type', 'account_id', 'video_url', 'language']
        db.delete_unique('externalsites_syncedsubtitleversion', ['account_type', 'account_id', 'video_url_id', 'language_id'])

        # Deleting model 'SyncHistory'
        db.delete_table('externalsites_synchistory')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 12, 12, 29, 11, 914122)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 12, 12, 29, 11, 914040)'}),
