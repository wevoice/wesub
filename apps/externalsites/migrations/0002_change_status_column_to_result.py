...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('externalsites_synchistory', 'status', 'result')

    def backwards(self, orm):
        db.rename_column('externalsites_synchistory', 'result', 'status')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 16, 16, 7, 17, 677951)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 16, 16, 7, 17, 677871)'}),
