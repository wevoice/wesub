...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YouTubeAccount.import_team'
        db.add_column('externalsites_youtubeaccount', 'import_team',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'YouTubeAccount.import_team'
        db.delete_column('externalsites_youtubeaccount', 'import_team_id')
    ...
    models = {
        ...
        'externalsites.youtubeaccount': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'import_team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Team']", 'null': 'True'}),
            'last_import_video_id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
