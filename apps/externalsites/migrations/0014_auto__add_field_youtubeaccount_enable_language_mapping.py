...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YouTubeAccount.enable_language_mapping'
        db.add_column('externalsites_youtubeaccount', 'enable_language_mapping',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'YouTubeAccount.enable_language_mapping'
        db.delete_column('externalsites_youtubeaccount', 'enable_language_mapping')
