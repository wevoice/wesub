...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OpenIDConnectLink'
        db.create_table('externalsites_openidconnectlink', (
            ('sub', self.gf('django.db.models.fields.CharField')(max_length=255, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='openid_connect_link', unique=True, to=orm['auth.CustomUser'])),
        ))
        db.send_create_signal('externalsites', ['OpenIDConnectLink'])

    def backwards(self, orm):
        # Deleting model 'OpenIDConnectLink'
        db.delete_table('externalsites_openidconnectlink')
