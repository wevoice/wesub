...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'YouTubeAccount.last_import_video_id'
        db.add_column('externalsites_youtubeaccount', 'last_import_video_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'YouTubeAccount.last_import_video_id'
        db.delete_column('externalsites_youtubeaccount', 'last_import_video_id')
