...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'SubtitleViewsPerMonth', fields ['date']
        db.create_index('statistic_subtitleviewspermonth', ['date'])

        # Adding index on 'VideoHitsPerMonth', fields ['date']
        db.create_index('statistic_videohitspermonth', ['date'])

        # Adding index on 'SubtitleViewsPerDay', fields ['date']
        db.create_index('statistic_subtitleviewsperday', ['date'])

        # Adding index on 'LastHitCountMigration', fields ['date']
        db.create_index('statistic_lasthitcountmigration', ['date'])

        # Adding index on 'SubtitleView', fields ['datetime']
        db.create_index('statistic_subtitleview', ['datetime'])

        # Adding index on 'VideoHit', fields ['datetime']
        db.create_index('statistic_videohit', ['datetime'])

        # Adding index on 'VideoViewCounter', fields ['date']
        db.create_index('statistic_videoviewcounter', ['date'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'SubtitleViewsPerMonth', fields ['date']
        db.delete_index('statistic_subtitleviewspermonth', ['date'])

        # Removing index on 'VideoHitsPerMonth', fields ['date']
        db.delete_index('statistic_videohitspermonth', ['date'])

        # Removing index on 'SubtitleViewsPerDay', fields ['date']
        db.delete_index('statistic_subtitleviewsperday', ['date'])

        # Removing index on 'LastHitCountMigration', fields ['date']
        db.delete_index('statistic_lasthitcountmigration', ['date'])

        # Removing index on 'SubtitleView', fields ['datetime']
        db.delete_index('statistic_subtitleview', ['datetime'])

        # Removing index on 'VideoHit', fields ['datetime']
        db.delete_index('statistic_videohit', ['datetime'])

        # Removing index on 'VideoViewCounter', fields ['date']
        db.delete_index('statistic_videoviewcounter', ['date'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 30, 9, 28, 52, 496812)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 30, 9, 28, 52, 496575)'}),
        ...
        'statistic.lasthitcountmigration': {
            'Meta': {'object_name': 'LastHitCountMigration'},
            'date': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '1', 'primary_key': 'True'})
        },
        'statistic.subtitleview': {
            'Meta': {'object_name': 'SubtitleView'},
        ...
        'statistic.subtitleviewsperday': {
            'Meta': {'unique_together': "(('subtitle_language', 'date'),)", 'object_name': 'SubtitleViewsPerDay'},
            'count': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'date': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subtitle_language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['subtitles.SubtitleLanguage']"})
        },
        'statistic.subtitleviewspermonth': {
            'Meta': {'unique_together': "(('subtitle_language', 'date'),)", 'object_name': 'SubtitleViewsPerMonth'},
            'count': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'date': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subtitle_language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['subtitles.SubtitleLanguage']"})
        ...
        'statistic.videohit': {
            'Meta': {'object_name': 'VideoHit'},
            'datetime': ('django.db.models.fields.DateTimeField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.Video']"})
        },
        'statistic.videohitspermonth': {
            'Meta': {'unique_together': "(('video', 'date'),)", 'object_name': 'VideoHitsPerMonth'},
            'count': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'date': ('django.db.models.fields.DateField', [], {'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.Video']"})
