...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.max_tasks_per_member'
        db.add_column('teams_team', 'max_tasks_per_member', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.max_tasks_per_member'
        db.delete_column('teams_team', 'max_tasks_per_member')
    ...
    models = {
        ...
        'teams.team': {
            ...
            'max_tasks_per_member': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True'}),
