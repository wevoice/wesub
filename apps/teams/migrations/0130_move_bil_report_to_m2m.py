...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for report in BillingReport.objects.all() :
            if report.team:
                report.teams.add(report.team)
    
    
    def backwards(self, orm):
        '''
        This will loose data, only the very first team will be listed here.
        '''
        BillingReport = orm['teams.BillingReport']
        for report in BillingReport.objects.all() :
            if report.teams.exists():
                report.team = report.teams.all()[0]
                report.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 21, 16, 35, 49, 145560)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 21, 16, 35, 49, 145459)'}),
