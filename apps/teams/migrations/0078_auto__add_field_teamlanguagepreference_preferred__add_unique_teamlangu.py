...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamLanguagePreference.preferred'
        db.add_column('teams_teamlanguagepreference', 'preferred', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding unique constraint on 'TeamLanguagePreference', fields ['language_code', 'team']
        db.create_unique('teams_teamlanguagepreference', ['language_code', 'team_id'])
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamLanguagePreference.preferred'
        db.delete_column('teams_teamlanguagepreference', 'preferred')

        # Removing unique constraint on 'TeamLanguagePreference', fields ['language_code', 'team']
        db.delete_unique('teams_teamlanguagepreference', ['language_code', 'team_id'])
