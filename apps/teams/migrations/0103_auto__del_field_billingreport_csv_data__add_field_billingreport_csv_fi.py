...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BillingReport.csv_data'
        db.delete_column('teams_billingreport', 'csv_data')

        # Adding field 'BillingReport.csv_file'
        db.add_column('teams_billingreport', 'csv_file', self.gf('utils.amazon.fields.S3EnabledFileField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'BillingReport.csv_data'
        db.add_column('teams_billingreport', 'csv_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'BillingReport.csv_file'
        db.delete_column('teams_billingreport', 'csv_file')
