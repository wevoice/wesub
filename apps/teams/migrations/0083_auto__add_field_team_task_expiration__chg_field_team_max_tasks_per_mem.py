...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.task_expiration'
        db.add_column('teams_team', 'task_expiration', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True, blank=True), keep_default=False)

        # Changing field 'Team.max_tasks_per_member'
        db.alter_column('teams_team', 'max_tasks_per_member', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.task_expiration'
        db.delete_column('teams_team', 'task_expiration')

        # Changing field 'Team.max_tasks_per_member'
        db.alter_column('teams_team', 'max_tasks_per_member', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
