...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TeamVideo.title'
        db.delete_column('teams_teamvideo', 'title')
    
    
    def backwards(self, orm):
        
        # Adding field 'TeamVideo.title'
        db.add_column('teams_teamvideo', 'title', self.gf('django.db.models.fields.CharField')(default=None, max_length=2048, blank=True), keep_default=False)
