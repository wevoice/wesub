...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.square_logo'
        db.add_column('teams_team', 'square_logo', self.gf('utils.amazon.fields.S3EnabledImageField')(default='', max_length=100, thumb_sizes=[(100, 100), (48, 48)], blank=True), keep_default=False)

        # Changing field 'Team.logo'
        db.alter_column('teams_team', 'logo', self.gf('utils.amazon.fields.S3EnabledImageField')(max_length=100, thumb_sizes=[(280, 100), (100, 100)], blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.square_logo'
        db.delete_column('teams_team', 'square_logo')

        # Changing field 'Team.logo'
        db.alter_column('teams_team', 'logo', self.gf('utils.amazon.fields.S3EnabledImageField')(max_length=100, thumb_sizes=[(280, 100), (100, 100), (48, 48)], blank=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 15, 19, 30, 633955)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 17, 15, 19, 30, 633874)'}),
