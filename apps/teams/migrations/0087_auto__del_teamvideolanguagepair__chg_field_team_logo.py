...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'TeamVideoLanguagePair'
        db.delete_table('teams_teamvideolanguagepair')

        # Changing field 'Team.logo'
        db.alter_column('teams_team', 'logo', self.gf('utils.amazon.fields.S3EnabledImageField')(thumb_options={'upscale': True, 'autocrop': True}, max_length=100, blank=True))
    
    
    def backwards(self, orm):
        
        # Adding model 'TeamVideoLanguagePair'
        db.create_table('teams_teamvideolanguagepair', (
            ...
            ('subtitle_language_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='team_video_language_pairs_1', null=True, to=orm['videos.SubtitleLanguage'])),
            ('subtitle_language_0', self.gf('django.db.models.fields.related.ForeignKey')(related_name='team_video_language_pairs_0', to=orm['videos.SubtitleLanguage'])),
