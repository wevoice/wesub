...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('teams_billingrecord', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'BillingRecord.video'
        db.alter_column('teams_billingrecord', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 9, 55, 38, 977026)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 9, 55, 38, 976966)'}),
