...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('teams_task', 'priority', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Task.priority'
        db.delete_column('teams_task', 'priority')
