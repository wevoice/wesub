...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamSubtitleNote.user'
        db.alter_column('teams_teamsubtitlenote', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.CustomUser']))
    
    
    def backwards(self, orm):
        
        # Changing field 'TeamSubtitleNote.user'
        db.alter_column('teams_teamsubtitlenote', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 18, 20, 1, 49, 849469)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 18, 20, 1, 49, 849364)'}),
