...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamVideo.partner_id'
        db.add_column('teams_teamvideo', 'partner_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamVideo.partner_id'
        db.delete_column('teams_teamvideo', 'partner_id')
