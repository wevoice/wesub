...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BillingReport.team'
        db.delete_column('teams_billingreport', 'team_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'BillingReport.team'
        db.add_column('teams_billingreport', 'team', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['teams.Team']), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 15, 19, 9, 618199)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 22, 15, 19, 9, 618080)'}),
