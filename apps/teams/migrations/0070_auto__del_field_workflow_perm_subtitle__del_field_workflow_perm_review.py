...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Workflow.perm_subtitle'
        db.delete_column('teams_workflow', 'perm_subtitle')

        # Deleting field 'Workflow.perm_review'
        db.delete_column('teams_workflow', 'perm_review')

        # Deleting field 'Workflow.perm_approve'
        db.delete_column('teams_workflow', 'perm_approve')

        # Deleting field 'Workflow.perm_translate'
        db.delete_column('teams_workflow', 'perm_translate')

        # Adding field 'Workflow.review_allowed'
        db.add_column('teams_workflow', 'review_allowed', self.gf('django.db.models.fields.PositiveIntegerField')(default=10), keep_default=False)

        # Adding field 'Workflow.approve_allowed'
        db.add_column('teams_workflow', 'approve_allowed', self.gf('django.db.models.fields.PositiveIntegerField')(default=10), keep_default=False)

        # Adding field 'Workflow.autocreate_subtitle'
        db.add_column('teams_workflow', 'autocreate_subtitle', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'Workflow.autocreate_translate'
        db.add_column('teams_workflow', 'autocreate_translate', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Workflow.perm_subtitle'
        db.add_column('teams_workflow', 'perm_subtitle', self.gf('django.db.models.fields.PositiveIntegerField')(default=20), keep_default=False)

        # Adding field 'Workflow.perm_review'
        db.add_column('teams_workflow', 'perm_review', self.gf('django.db.models.fields.PositiveIntegerField')(default=40), keep_default=False)

        # Adding field 'Workflow.perm_approve'
        db.add_column('teams_workflow', 'perm_approve', self.gf('django.db.models.fields.PositiveIntegerField')(default=60), keep_default=False)

        # Adding field 'Workflow.perm_translate'
        db.add_column('teams_workflow', 'perm_translate', self.gf('django.db.models.fields.PositiveIntegerField')(default=20), keep_default=False)

        # Deleting field 'Workflow.review_allowed'
        db.delete_column('teams_workflow', 'review_allowed')

        # Deleting field 'Workflow.approve_allowed'
        db.delete_column('teams_workflow', 'approve_allowed')

        # Deleting field 'Workflow.autocreate_subtitle'
        db.delete_column('teams_workflow', 'autocreate_subtitle')

        # Deleting field 'Workflow.autocreate_translate'
        db.delete_column('teams_workflow', 'autocreate_translate')
    ...
    models = {
        ...
        'teams.workflow': {
            ...
            'approve_allowed': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10'}),
            ...
            'review_allowed': ('django.db.models.fields.PositiveIntegerField', [], {'default': '10'}),
            'team': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['teams.Team']"}),
