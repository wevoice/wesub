...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Setting', fields ['language_code', 'key', 'team']
        db.create_unique('teams_setting', ['language_code', 'key', 'team_id'])

    def backwards(self, orm):
        # Removing unique constraint on 'Setting', fields ['language_code', 'key', 'team']
        db.delete_unique('teams_setting', ['language_code', 'key', 'team_id'])
