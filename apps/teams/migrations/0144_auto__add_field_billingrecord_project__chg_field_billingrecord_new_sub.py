...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BillingRecord.project'
        db.add_column('teams_billingrecord', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Project'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)


        # Changing field 'BillingRecord.new_subtitle_version'
        db.alter_column('teams_billingrecord', 'new_subtitle_version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleVersion'], null=True, on_delete=models.SET_NULL))

        # Changing field 'BillingRecord.video'
        db.alter_column('teams_billingrecord', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'], null=True, on_delete=models.SET_NULL))

        # Changing field 'BillingRecord.subtitle_version'
        db.alter_column('teams_billingrecord', 'subtitle_version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleVersion'], null=True, on_delete=models.SET_NULL))

        # Changing field 'BillingRecord.new_subtitle_language'
        db.alter_column('teams_billingrecord', 'new_subtitle_language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleLanguage'], null=True, on_delete=models.SET_NULL))

        # Changing field 'BillingRecord.subtitle_language'
        db.alter_column('teams_billingrecord', 'subtitle_language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage'], null=True, on_delete=models.SET_NULL))
    def backwards(self, orm):
        # Deleting field 'BillingRecord.project'
        db.delete_column('teams_billingrecord', 'project_id')


        # Changing field 'BillingRecord.new_subtitle_version'
        db.alter_column('teams_billingrecord', 'new_subtitle_version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleVersion'], null=True))

        # Changing field 'BillingRecord.video'
        db.alter_column('teams_billingrecord', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'], null=True))

        # Changing field 'BillingRecord.subtitle_version'
        db.alter_column('teams_billingrecord', 'subtitle_version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleVersion'], null=True))

        # Changing field 'BillingRecord.new_subtitle_language'
        db.alter_column('teams_billingrecord', 'new_subtitle_language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleLanguage'], null=True))

        # Changing field 'BillingRecord.subtitle_language'
        db.alter_column('teams_billingrecord', 'subtitle_language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage'], null=True))
    models = {
        'auth.customuser': {
