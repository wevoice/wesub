...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Setting.language_code'
        db.add_column('teams_setting', 'language_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Setting.language_code'
        db.delete_column('teams_setting', 'language_code')
