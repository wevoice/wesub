...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.workflow_type'
        db.add_column('teams_team', 'workflow_type', self.gf('django.db.models.fields.CharField')(default='O', max_length=2), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.workflow_type'
        db.delete_column('teams_team', 'workflow_type')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 15, 11, 15, 17, 466009)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 9, 15, 11, 15, 17, 465928)'}),
