...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamVideo.added_by'
        db.alter_column('teams_teamvideo', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'], null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'TeamVideo.added_by'
        db.alter_column('teams_teamvideo', 'added_by_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser']))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 25, 10, 12, 43, 700044)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 25, 10, 12, 43, 699965)'}),
