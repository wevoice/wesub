...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.partner'
        db.add_column('teams_team', 'partner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Partner'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.partner'
        db.delete_column('teams_team', 'partner_id')
