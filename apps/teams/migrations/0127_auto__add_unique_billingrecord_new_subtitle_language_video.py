...
ON tb.video_id = subquery.video_id AND
   ...
   tb.id != subquery.min_id
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'BillingRecord', fields ['new_subtitle_language', 'video']
        db.delete_unique('teams_billingrecord', ['new_subtitle_language_id', 'video_id'])
    ...
    models = {
        ...
        'teams.billingrecord': {
            'Meta': {'unique_together': "(('video', 'subtitle_language'), ('video', 'new_subtitle_language'))", 'object_name': 'BillingRecord'},
            'created': ('django.db.models.fields.DateTimeField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
