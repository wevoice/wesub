...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamNotificationSetting.team'
        db.alter_column('teams_teamnotificationsetting', 'team_id', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, unique=True, null=True, to=orm['teams.Team']))
    
    
    def backwards(self, orm):
        
        # Changing field 'TeamNotificationSetting.team'
        db.alter_column('teams_teamnotificationsetting', 'team_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['teams.Team']))
