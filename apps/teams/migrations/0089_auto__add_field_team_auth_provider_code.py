...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.auth_provider_code'
        db.add_column('teams_team', 'auth_provider_code', self.gf('django.db.models.fields.CharField')(default='', max_length=24, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.auth_provider_code'
        db.delete_column('teams_team', 'auth_provider_code')
