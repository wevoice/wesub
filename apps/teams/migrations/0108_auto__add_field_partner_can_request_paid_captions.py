...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Partner.can_request_paid_captions'
        db.add_column('teams_partner', 'can_request_paid_captions', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Partner.can_request_paid_captions'
        db.delete_column('teams_partner', 'can_request_paid_captions')
