...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'BillingRecord', fields ['subtitle_language', 'video']
        try:
            db.delete_unique('teams_billingrecord', ['subtitle_language_id', 'video_id'])
        except ValueError:
            # due to a bug in south, this constraint might be removed already
            pass
    
    
    def backwards(self, orm):
        
        # Adding unique constraint on 'BillingRecord', fields ['subtitle_language', 'video']
        db.create_unique('teams_billingrecord', ['subtitle_language_id', 'video_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 21, 16, 52, 5, 892984)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 21, 16, 52, 5, 892825)'}),
