...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.subtitle_version'
        db.add_column('teams_task', 'subtitle_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleVersion'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Task.subtitle_version'
        db.delete_column('teams_task', 'subtitle_version_id')
