...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('teams_billingrecord', (
            ...
            ('subtitle_language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage'])),
            ...
            ('subtitle_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleVersion'])),
