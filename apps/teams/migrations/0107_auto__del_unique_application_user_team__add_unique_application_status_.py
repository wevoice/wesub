...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Application', fields ['user', 'team']
        db.delete_unique('teams_application', ['user_id', 'team_id'])

        # Adding unique constraint on 'Application', fields ['status', 'user', 'team']
        db.create_unique('teams_application', ['status', 'user_id', 'team_id'])
    
    
    def backwards(self, orm):
        
        # Adding unique constraint on 'Application', fields ['user', 'team']
        db.create_unique('teams_application', ['user_id', 'team_id'])

        # Removing unique constraint on 'Application', fields ['status', 'user', 'team']
        db.delete_unique('teams_application', ['status', 'user_id', 'team_id'])
