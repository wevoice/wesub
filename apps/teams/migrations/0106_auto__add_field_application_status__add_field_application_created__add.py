...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('teams_application', 'status', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'Application.created'
        db.add_column('teams_application', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 8, 8, 15, 50, 18, 541728), blank=True), keep_default=False)

        # Adding field 'Application.modified'
        db.add_column('teams_application', 'modified', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Application.status'
        db.delete_column('teams_application', 'status')

        # Deleting field 'Application.created'
        db.delete_column('teams_application', 'created')

        # Deleting field 'Application.modified'
        db.delete_column('teams_application', 'modified')
