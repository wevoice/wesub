...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Invite', fields ['user', 'team']
        db.delete_unique('teams_invite', ['user_id', 'team_id'])
    
    
    def backwards(self, orm):
        
        # Adding unique constraint on 'Invite', fields ['user', 'team']
        db.create_unique('teams_invite', ['user_id', 'team_id'])
