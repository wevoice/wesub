...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MembershipNarrowing.object_pk'
        db.delete_column('teams_membershipnarrowing', 'object_pk')

        # Deleting field 'MembershipNarrowing.content_type'
        db.delete_column('teams_membershipnarrowing', 'content_type_id')

        # Adding field 'MembershipNarrowing.project'
        db.add_column('teams_membershipnarrowing', 'project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Project'], null=True, blank=True), keep_default=False)

        # Adding field 'MembershipNarrowing.language'
        db.add_column('teams_membershipnarrowing', 'language', self.gf('django.db.models.fields.CharField')(default=1, max_length=24, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'MembershipNarrowing.object_pk'
        db.add_column('teams_membershipnarrowing', 'object_pk', self.gf('django.db.models.fields.TextField')(default=1), keep_default=False)

        # Adding field 'MembershipNarrowing.content_type'
        db.add_column('teams_membershipnarrowing', 'content_type', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='content_type_set_for_membershipnarrowing', to=orm['contenttypes.ContentType']), keep_default=False)

        # Deleting field 'MembershipNarrowing.project'
        db.delete_column('teams_membershipnarrowing', 'project_id')

        # Deleting field 'MembershipNarrowing.language'
        db.delete_column('teams_membershipnarrowing', 'language')
