...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.translate_policy'
        db.add_column('teams_team', 'translate_policy', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)

        # Adding field 'Team.subtitle_policy'
        db.add_column('teams_team', 'subtitle_policy', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)

        # Adding field 'Team.task_assign_policy'
        db.add_column('teams_team', 'task_assign_policy', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.translate_policy'
        db.delete_column('teams_team', 'translate_policy')

        # Deleting field 'Team.subtitle_policy'
        db.delete_column('teams_team', 'subtitle_policy')

        # Deleting field 'Team.task_assign_policy'
        db.delete_column('teams_team', 'task_assign_policy')
