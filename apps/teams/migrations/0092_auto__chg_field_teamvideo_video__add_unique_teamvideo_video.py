...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamVideo.video'
        db.alter_column('teams_teamvideo', 'video_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['videos.Video'], unique=True))

        # Adding unique constraint on 'TeamVideo', fields ['video']
        db.create_unique('teams_teamvideo', ['video_id'])
    
    
    def backwards(self, orm):
        
        # Changing field 'TeamVideo.video'
        db.alter_column('teams_teamvideo', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video']))

        # Removing unique constraint on 'TeamVideo', fields ['video']
        db.delete_unique('teams_teamvideo', ['video_id'])
