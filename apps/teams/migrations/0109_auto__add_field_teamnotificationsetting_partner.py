...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamNotificationSetting.partner'
        db.add_column('teams_teamnotificationsetting', 'partner', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['teams.Partner'], unique=True, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamNotificationSetting.partner'
        db.delete_column('teams_teamnotificationsetting', 'partner_id')
