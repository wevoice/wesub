...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Task.assignment_date'
        db.delete_column('teams_task', 'assignment_date')

        # Adding field 'Task.expiration_date'
        db.add_column('teams_task', 'expiration_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'Task.assignment_date'
        db.add_column('teams_task', 'assignment_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Task.expiration_date'
        db.delete_column('teams_task', 'expiration_date')
