...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table('teams_teamvideolanguage', (
            ('is_lingua_franca', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True, db_index=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=16, db_index=True)),
            ('team_video', self.gf('django.db.models.fields.related.ForeignKey')(related_name='languages', to=orm['teams.TeamVideo'])),
            ('is_original', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True, db_index=True)),
            ('is_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True, db_index=True)),
            ...
            ('forked', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True, db_index=True)),
            ('percent_done', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
            ('subtitle_language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage'], null=True)),
