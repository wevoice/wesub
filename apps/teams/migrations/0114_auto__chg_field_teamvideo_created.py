...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        pass
        # this migration is empty because we don't need to actually alter the table
        # just so that auto_now is gone, but we still need the frozen
        # state to hold, see http://south.aeracode.org/ticket/795
