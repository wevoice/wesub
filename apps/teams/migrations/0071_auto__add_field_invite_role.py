...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Invite.role'
        db.add_column('teams_invite', 'role', self.gf('django.db.models.fields.CharField')(default='contributor', max_length=16), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Invite.role'
        db.delete_column('teams_invite', 'role')
