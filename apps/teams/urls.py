...
urlpatterns += patterns('teams.new_views',
    ...
    url(r'^(?P<slug>[-\w]+)/members/invite/user-search/$', 'invite_user_search', name='invite-user-search'),
    ...
    url(r'^(?P<slug>[-\w]+)/projects/(?P<project_slug>[-\w]+)/add-manager-search$', 'add_project_manager_search', name='add-project-manager-search'),
    url(r'^(?P<slug>[-\w]+)/languages/(?P<language_code>[-\w]+)/$', 'language_page', name='language-page'),
    url(r'^(?P<slug>[-\w]+)/languages/(?P<language_code>[-\w]+)/add-manager-search$', 'add_language_manager_search', name='add-language-manager-search'),
