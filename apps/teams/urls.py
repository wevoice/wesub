...
urlpatterns = patterns('teams.views',
    ...
    url('^move/$', 'move_video', name='move_video'),
    ...
    url('^(?P<slug>[-\w]+)/activity/$', 'activity', name='activity'),
    ...
    url('^(?P<slug>[-\w]+)/upload-draft/$', 'upload_draft', name='upload_draft'),
    url('^(?P<slug>[-\w]+)/(?P<task_pk>\d+)/download/(?P<type>[-\w]+)/$', 'download_draft', name='download_draft'),
