...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table('auth_customuser_third_party_accounts')
    
    
    def backwards(self, orm):
        
        # Adding M2M table for field third_party_accounts on 'CustomUser'
        db.create_table('auth_customuser_third_party_accounts', (
        ...
        db.create_unique('auth_customuser_third_party_accounts', ['customuser_id', 'thirdpartyaccount_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 19, 14, 31, 10, 565471)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 19, 14, 31, 10, 565383)'}),
