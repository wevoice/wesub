...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.playback_mode'
        db.add_column('auth_customuser', 'playback_mode',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CustomUser.playback_mode'
        db.delete_column('auth_customuser', 'playback_mode')
