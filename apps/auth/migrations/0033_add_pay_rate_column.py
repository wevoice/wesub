...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomUser.pay_rate_code'
        db.add_column('auth_customuser', 'pay_rate_code', self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True), keep_default=False)

    def backwards(self, orm):
        
        # Deleting field 'CustomUser.pay_rate_code'
        db.delete_column('auth_customuser', 'pay_rate_code')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 11, 15, 37, 53, 611867)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 11, 15, 37, 53, 611796)'}),
