...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserLanguage.priority'
        db.add_column('auth_userlanguage', 'priority',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'UserLanguage.priority'
        db.delete_column('auth_userlanguage', 'priority')
