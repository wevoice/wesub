...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.created_by'
        db.add_column('auth_customuser', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_users', null=True, to=orm['auth.CustomUser']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CustomUser.created_by'
        db.delete_column('auth_customuser', 'created_by_id')
