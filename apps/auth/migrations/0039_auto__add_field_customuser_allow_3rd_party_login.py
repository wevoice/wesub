...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.allow_3rd_party_login'
        db.add_column('auth_customuser', 'allow_3rd_party_login',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CustomUser.allow_3rd_party_login'
        db.delete_column('auth_customuser', 'allow_3rd_party_login')
