...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.rename_column("auth_customuser", "changes_notification", "notify_by_email")
        db.rename_column("auth_customuser", "follow_new_video", "notify_by_message")
    
    
    def backwards(self, orm):
        "Write your backwards methods here."
        db.rename_column("auth_customuser", "notify_by_email", "changes_notification")
        db.rename_column("auth_customuser",  "notify_by_message", "follow_new_video")
