...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('auth_customuser', 'partner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Partner'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('auth_customuser', 'partner_id')
