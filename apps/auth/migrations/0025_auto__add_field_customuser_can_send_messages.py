...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomUser.can_send_messages'
        db.add_column('auth_customuser', 'can_send_messages', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CustomUser.can_send_messages'
        db.delete_column('auth_customuser', 'can_send_messages')
