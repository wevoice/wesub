...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('socialauth_authmeta', (
            ('is_profile_modified', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('provider', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('is_email_filled', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.CustomUser'], unique=True)),
        ))
        db.send_create_signal('socialauth', ['AuthMeta'])

        # Adding model 'OpenidProfile'
        db.create_table('socialauth_openidprofile', (
            ('is_username_valid', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'])),
            ('openid_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ...
        db.create_table('socialauth_twitteruserprofile', (
            ('screen_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=200)),
        ...
        db.create_table('socialauth_facebookuserprofile', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'])),
            ('facebook_uid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
        ))
