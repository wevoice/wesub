...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleVersion.new_subtitle_version'
        db.add_column('videos_subtitleversion', 'new_subtitle_version', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='old_subtitle_version', unique=True, null=True, to=orm['subtitles.SubtitleVersion']), keep_default=False)

        # Adding field 'SubtitleVersion.needs_sync'
        db.add_column('videos_subtitleversion', 'needs_sync', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleVersion.new_subtitle_version'
        db.delete_column('videos_subtitleversion', 'new_subtitle_version_id')

        # Deleting field 'SubtitleVersion.needs_sync'
        db.delete_column('videos_subtitleversion', 'needs_sync')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 27, 11, 23, 45, 283253)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 27, 11, 23, 45, 283153)'}),
