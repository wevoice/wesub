...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subtitle.start_of_paragraph'
        db.add_column('videos_subtitle', 'start_of_paragraph', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    
    
    def backwards(self, orm):
        # Deleting field 'Subtitle.start_of_paragraph'
        db.delete_column('videos_subtitle', 'start_of_paragraph')
