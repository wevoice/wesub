...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('videos_videoindex', (
            ...
            ('needs_update', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True)),
            ('update_lock_time', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('update_lock_key', self.gf('django.db.models.fields.CharField')(default='', max_length=11, db_index=True)),
        ))

        self.setup_indexes(orm)
        db.send_create_signal('videos', ['VideoIndex'])

    def setup_indexes(self, orm):
        results = db.execute('SELECT constraint_name '
        ...
        db.execute('ALTER TABLE videos_videoindex ENGINE=MyISAM')
        db.execute('ALTER TABLE videos_videoindex '
    ...
    models = {
        ...
        'videos.videoindex': {
            ...
            'update_lock_key': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '11', 'db_index': 'True'}),
            'update_lock_time': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
