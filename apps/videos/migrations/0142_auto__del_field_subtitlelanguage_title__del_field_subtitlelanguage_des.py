...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubtitleLanguage.description'
        db.delete_column('videos_subtitlelanguage', 'description')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'SubtitleLanguage.description'
        db.add_column('videos_subtitlelanguage', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
