...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.member'
        db.add_column('videos_action', 'member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.TeamMember'], null=True, blank=True), keep_default=False)

        # Changing field 'Action.video'
        db.alter_column('videos_action', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Action.member'
        db.delete_column('videos_action', 'member_id')

        # Changing field 'Action.video'
        db.alter_column('videos_action', 'video_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video']))
