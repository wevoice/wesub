...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleVersion.forked_from'
        db.add_column('videos_subtitleversion', 'forked_from', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleVersion'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleVersion.forked_from'
        db.delete_column('videos_subtitleversion', 'forked_from_id')
