...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VideoIndex.needs_update'
        db.delete_column('videos_videoindex', 'needs_update')

        # Deleting field 'VideoIndex.update_lock_time'
        db.delete_column('videos_videoindex', 'update_lock_time')

        # Deleting field 'VideoIndex.update_lock_key'
        db.delete_column('videos_videoindex', 'update_lock_key')

    def backwards(self, orm):
        # Adding field 'VideoIndex.needs_update'
        db.add_column('videos_videoindex', 'needs_update',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'VideoIndex.update_lock_time'
        db.add_column('videos_videoindex', 'update_lock_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=None, null=True),
                      keep_default=False)

        # Adding field 'VideoIndex.update_lock_key'
        db.add_column('videos_videoindex', 'update_lock_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=11, db_index=True),
                      keep_default=False)
