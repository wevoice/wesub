...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoFeed.last_update'
        db.add_column('videos_videofeed', 'last_update', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VideoFeed.last_update'
        db.delete_column('videos_videofeed', 'last_update')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 23, 9, 2, 33, 187245)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 23, 9, 2, 33, 187159)'}),
