...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 2, 13, 25, 32, 531633)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 10, 2, 13, 25, 32, 531562)'}),
        ...
        'videos.videourl': {
            'Meta': {'unique_together': "(('url', 'type'),)", 'object_name': 'VideoUrl'},
