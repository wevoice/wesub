...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('videos_subtitlelanguage', 'new_subtitle_language_id', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, null=True, to=orm['subtitles.SubtitleLanguage']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SubtitleLanguage.new_subtitle_language'
        db.alter_column('videos_subtitlelanguage', 'new_subtitle_language_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['subtitles.SubtitleLanguage'], blank=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 29, 10, 39, 35, 221892)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 29, 10, 39, 35, 221793)'}),
