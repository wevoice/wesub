...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # this migraation will convert the times from seconds to milliseconds
        # doing this in code took about 200 hours, on the SQL level, about 35 minutes
        db.execute("UPDATE videos_subtitle SET start_time_ms = start_time * 1000 WHERE (start_time != -1) AND (start_time is not NUll);")
        db.execute("UPDATE videos_subtitle SET end_time_ms = end_time * 1000  WHERE (end_time != -1) AND (end_time is not NUll);")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 14, 46, 26, 758881)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 3, 14, 46, 26, 758724)'}),
