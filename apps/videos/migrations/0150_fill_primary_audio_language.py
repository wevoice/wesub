...
def original_subtitle_language(video):
    """Return the SL in the original language of this video or None."""
    sl = list(video.subtitlelanguage_set.filter(is_original=True)[:1])
...
def language(video):
    ...
    Will return '' if unknown.

    """
    ol = original_subtitle_language(video)
...
class Migration(DataMigration):
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 14, 56, 17, 467610)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 26, 14, 56, 17, 467452)'}),
