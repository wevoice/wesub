...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubtitleLanguage.created'
        db.alter_column('videos_subtitlelanguage', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'VideoUrl.created'
        db.alter_column('videos_videourl', 'created', self.gf('django.db.models.fields.DateTimeField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'SubtitleLanguage.created'
        db.alter_column('videos_subtitlelanguage', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))

        # Changing field 'VideoUrl.created'
        db.alter_column('videos_videourl', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True))
