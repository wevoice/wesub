...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleVersion.description'
        db.add_column('videos_subtitleversion', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubtitleVersion.description'
        db.delete_column('videos_subtitleversion', 'description')
