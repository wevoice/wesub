...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VideoFeed.last_link'
        db.delete_column('videos_videofeed', 'last_link')
    
    
    def backwards(self, orm):
        
        # Adding field 'VideoFeed.last_link'
        db.add_column('videos_videofeed', 'last_link', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 30, 8, 22, 40, 197628)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 30, 8, 22, 40, 197547)'}),
        ...
        'videos.importedvideo': {
            'Meta': {'object_name': 'ImportedVideo'},
