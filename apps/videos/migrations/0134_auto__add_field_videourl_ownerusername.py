...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoUrl.ownerusername'
        db.add_column('videos_videourl', 'owner_username', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VideoUrl.ownerusername'
        db.delete_column('videos_videourl', 'owner_username')
    ...
    models = {
        ...
        'videos.videourl': {
            ...
            'ownerusername': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
