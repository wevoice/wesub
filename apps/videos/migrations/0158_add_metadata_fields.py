...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.meta_2_type'
        db.add_column('videos_video', 'meta_2_type', self.gf('videos.metadata.MetadataTypeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Video.meta_1_type'
        db.add_column('videos_video', 'meta_1_type', self.gf('videos.metadata.MetadataTypeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Video.meta_2_content'
        db.add_column('videos_video', 'meta_2_content', self.gf('videos.metadata.MetadataContentField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Video.meta_1_content'
        db.add_column('videos_video', 'meta_1_content', self.gf('videos.metadata.MetadataContentField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Video.meta_3_type'
        db.add_column('videos_video', 'meta_3_type', self.gf('videos.metadata.MetadataTypeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Video.meta_3_content'
        db.add_column('videos_video', 'meta_3_content', self.gf('videos.metadata.MetadataContentField')(default='', max_length=255, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.meta_2_type'
        db.delete_column('videos_video', 'meta_2_type')

        # Deleting field 'Video.meta_1_type'
        db.delete_column('videos_video', 'meta_1_type')

        # Deleting field 'Video.meta_2_content'
        db.delete_column('videos_video', 'meta_2_content')

        # Deleting field 'Video.meta_1_content'
        db.delete_column('videos_video', 'meta_1_content')

        # Deleting field 'Video.meta_3_type'
        db.delete_column('videos_video', 'meta_3_type')

        # Deleting field 'Video.meta_3_content'
        db.delete_column('videos_video', 'meta_3_content')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 12, 5, 9, 613094)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 12, 5, 9, 612931)'}),
