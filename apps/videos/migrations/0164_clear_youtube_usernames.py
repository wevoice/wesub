...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # set owner_username to NULL.  We used to use the regular youtube
        # username for this, but now we switched to using the channel id,
        # which is more general.  The syncing code will have a special case to
        # regenerate owner_username when we try to sync videos.

        orm.VideoUrl.objects.filter(type='Y').update(owner_username=None)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 18, 20, 39, 332196)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 10, 18, 20, 39, 332112)'}),
