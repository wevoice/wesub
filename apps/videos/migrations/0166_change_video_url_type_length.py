...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VideoUrl.type'
        db.alter_column('videos_videourl', 'type', self.gf('django.db.models.fields.CharField')(max_length=2))
    def backwards(self, orm):

        # Changing field 'VideoUrl.type'
        db.alter_column('videos_videourl', 'type', self.gf('django.db.models.fields.CharField')(max_length=1))
    models = {
        'auth.customuser': {
