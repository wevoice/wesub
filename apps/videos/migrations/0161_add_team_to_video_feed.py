...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserTestResult.get_updates'
        db.alter_column('videos_usertestresult', 'get_updates', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleLanguage.had_version'
        db.alter_column('videos_subtitlelanguage', 'had_version', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleLanguage.is_original'
        db.alter_column('videos_subtitlelanguage', 'is_original', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleLanguage.is_complete'
        db.alter_column('videos_subtitlelanguage', 'is_complete', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleLanguage.is_forked'
        db.alter_column('videos_subtitlelanguage', 'is_forked', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleLanguage.needs_sync'
        db.alter_column('videos_subtitlelanguage', 'needs_sync', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleLanguage.has_version'
        db.alter_column('videos_subtitlelanguage', 'has_version', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Subtitle.start_of_paragraph'
        db.alter_column('videos_subtitle', 'start_of_paragraph', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleVersion.result_of_rollback'
        db.alter_column('videos_subtitleversion', 'result_of_rollback', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleVersion.notification_sent'
        db.alter_column('videos_subtitleversion', 'notification_sent', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleVersion.is_forked'
        db.alter_column('videos_subtitleversion', 'is_forked', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'SubtitleVersion.needs_sync'
        db.alter_column('videos_subtitleversion', 'needs_sync', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Video.is_subtitled'
        db.alter_column('videos_video', 'is_subtitled', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Video.was_subtitled'
        db.alter_column('videos_video', 'was_subtitled', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Video.s3_thumbnail'
        db.alter_column('videos_video', 's3_thumbnail', self.gf('utils.amazon.fields.S3EnabledImageField')(max_length=100, thumb_sizes=((288, 162), (120, 90)), blank=True))

        # Changing field 'Video.is_public'
        db.alter_column('videos_video', 'is_public', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Video.allow_community_edits'
        db.alter_column('videos_video', 'allow_community_edits', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'Video.allow_video_urls_edit'
        db.alter_column('videos_video', 'allow_video_urls_edit', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'VideoUrl.original'
        db.alter_column('videos_videourl', 'original', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'VideoUrl.primary'
        db.alter_column('videos_videourl', 'primary', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Adding field 'VideoFeed.team'
        db.add_column('videos_videofeed', 'team', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['teams.Team'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Changing field 'UserTestResult.get_updates'
        db.alter_column('videos_usertestresult', 'get_updates', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleLanguage.had_version'
        db.alter_column('videos_subtitlelanguage', 'had_version', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleLanguage.is_original'
        db.alter_column('videos_subtitlelanguage', 'is_original', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleLanguage.is_complete'
        db.alter_column('videos_subtitlelanguage', 'is_complete', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleLanguage.is_forked'
        db.alter_column('videos_subtitlelanguage', 'is_forked', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleLanguage.needs_sync'
        db.alter_column('videos_subtitlelanguage', 'needs_sync', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleLanguage.has_version'
        db.alter_column('videos_subtitlelanguage', 'has_version', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Subtitle.start_of_paragraph'
        db.alter_column('videos_subtitle', 'start_of_paragraph', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleVersion.result_of_rollback'
        db.alter_column('videos_subtitleversion', 'result_of_rollback', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleVersion.notification_sent'
        db.alter_column('videos_subtitleversion', 'notification_sent', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleVersion.is_forked'
        db.alter_column('videos_subtitleversion', 'is_forked', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'SubtitleVersion.needs_sync'
        db.alter_column('videos_subtitleversion', 'needs_sync', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Video.is_subtitled'
        db.alter_column('videos_video', 'is_subtitled', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Video.was_subtitled'
        db.alter_column('videos_video', 'was_subtitled', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Video.s3_thumbnail'
        db.alter_column('videos_video', 's3_thumbnail', self.gf('utils.amazon.fields.S3EnabledImageField')(max_length=100, thumb_sizes=((290, 165), (120, 90)), blank=True))

        # Changing field 'Video.is_public'
        db.alter_column('videos_video', 'is_public', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Video.allow_community_edits'
        db.alter_column('videos_video', 'allow_community_edits', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Video.allow_video_urls_edit'
        db.alter_column('videos_video', 'allow_video_urls_edit', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VideoUrl.original'
        db.alter_column('videos_videourl', 'original', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'VideoUrl.primary'
        db.alter_column('videos_videourl', 'primary', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'VideoFeed.team'
        db.delete_column('videos_videofeed', 'team_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 13, 37, 30, 179047)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 7, 13, 37, 30, 178967)'}),
        ...
        'videos.subtitleversion': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'max_length': '2048', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['auth.CustomUser']"}),
