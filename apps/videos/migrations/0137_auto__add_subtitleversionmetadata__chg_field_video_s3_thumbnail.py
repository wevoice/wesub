...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('videos_video', 's3_thumbnail', self.gf('utils.amazon.fields.S3EnabledImageField')(thumb_options={'upscale': True, 'crop': 'smart'}, max_length=100, thumb_sizes=((290, 165), (120, 90)), blank=True))
