...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'SubtitleLanguage', fields ['has_version']
        db.create_index('videos_subtitlelanguage', ['has_version'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'SubtitleLanguage', fields ['has_version']
        db.delete_index('videos_subtitlelanguage', ['has_version'])
