...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subtitle.start_time_ms'
        db.add_column('videos_subtitle', 'start_time_ms', self.gf('django.db.models.fields.IntegerField')(default=None, null=True), keep_default=False)
        # Adding field 'Subtitle.end_time_ms'
        db.add_column('videos_subtitle', 'end_time_ms', self.gf('django.db.models.fields.IntegerField')(default=None, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Subtitle.start_time_ms'
        db.delete_column('videos_subtitle', 'start_time_ms')

        # Deleting field 'Subtitle.end_time_ms'
        db.delete_column('videos_subtitle', 'end_time_ms')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 1, 10, 42, 56, 418651)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 1, 10, 42, 56, 418548)'}),
        ...
        'videos.subtitle': {
            ...
            'end_time_ms': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start_time_ms': ('django.db.models.fields.IntegerField', [], {'default': 'None', 'null': 'True'}),
