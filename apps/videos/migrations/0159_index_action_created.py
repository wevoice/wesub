...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Action', fields ['created']
        db.create_index('videos_action', ['created'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'Action', fields ['created']
        db.delete_index('videos_action', ['created'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 23, 12, 45, 15, 505339)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 23, 12, 45, 15, 505232)'}),
