...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('thirdpartyaccounts_twitteraccount', (
        ...
        db.send_create_signal('thirdpartyaccounts', ['TwitterAccount'])

        # Adding model 'FacebookAccount'
        db.create_table('thirdpartyaccounts_facebookaccount', (
        ...
        db.send_create_signal('thirdpartyaccounts', ['FacebookAccount'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'TwitterAccount'
        db.delete_table('thirdpartyaccounts_twitteraccount')

        # Deleting model 'FacebookAccount'
        db.delete_table('thirdpartyaccounts_facebookaccount')
    ...
    complete_apps = ['thirdpartyaccounts', 'socialauth']
