...
def version_get_subtitles(sv):
    ...
    """
    return load_from(decompress(sv.serialized_subtitles), type='dfxp').to_internal()

class Migration(DataMigration):

    def forwards(self, orm):
        "Write your forwards methods here."
        for sv in orm.SubtitleVersion.objects.all():
            sv.subtitle_count = len(version_get_subtitles(sv))
            sv.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 25, 10, 53, 47, 390191)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 25, 10, 53, 47, 390093)'}),
