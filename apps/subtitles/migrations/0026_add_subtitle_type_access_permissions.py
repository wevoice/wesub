...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='subtitlelanguage', app_label='subtitles') # model must be lowercase!
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='subtitlelanguage_access_restricted_subtitle_format', defaults=dict(name=u'Can access restricted subtitle format'))
    ...
    complete_apps = ['contenttypes', 'auth', 'subtitles']
    symmetrical = True
