...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('subtitles_subtitleversion', 'note', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleVersion.note'
        db.delete_column('subtitles_subtitleversion', 'note')
