...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleLanguage.subtitles_complete'
        db.add_column('subtitles_subtitlelanguage', 'subtitles_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding unique constraint on 'SubtitleVersion', fields ['subtitle_language', 'version_number', 'video']
        db.create_unique('subtitles_subtitleversion', ['subtitle_language_id', 'version_number', 'video_id'])
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleLanguage.subtitles_complete'
        db.delete_column('subtitles_subtitlelanguage', 'subtitles_complete')

        # Removing unique constraint on 'SubtitleVersion', fields ['subtitle_language', 'version_number', 'video']
        db.delete_unique('subtitles_subtitleversion', ['subtitle_language_id', 'version_number', 'video_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 27, 15, 28, 23, 420439)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 27, 15, 28, 23, 420352)'}),
