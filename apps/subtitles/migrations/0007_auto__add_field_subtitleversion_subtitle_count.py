...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleVersion.subtitle_count'
        db.add_column('subtitles_subtitleversion', 'subtitle_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleVersion.subtitle_count'
        db.delete_column('subtitles_subtitleversion', 'subtitle_count')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 25, 10, 53, 32, 778081)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 25, 10, 53, 32, 777991)'}),
