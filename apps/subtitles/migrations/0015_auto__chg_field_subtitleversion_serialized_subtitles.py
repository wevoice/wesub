...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubtitleVersion.serialized_subtitles'
        db.alter_column('subtitles_subtitleversion', 'serialized_subtitles', self.gf('django.db.models.fields.TextField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'SubtitleVersion.serialized_subtitles'
        db.alter_column('subtitles_subtitleversion', 'serialized_subtitles', self.gf('django.db.models.fields.TextField')(blank=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 9, 43, 26, 633712)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 9, 43, 26, 633597)'}),
