...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleVersion.rollback_of_version_number'
        db.add_column('subtitles_subtitleversion', 'rollback_of_version_number', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleVersion.rollback_of_version_number'
        db.delete_column('subtitles_subtitleversion', 'rollback_of_version_number')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 28, 11, 27, 7, 502941)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 9, 28, 11, 27, 7, 502847)'}),
        ...
        'subtitles.subtitleversion': {
            ...
            'rollback_of_version_number': ('django.db.models.fields.PositiveIntegerField', [], {'default': 'None', 'null': 'True'}),
