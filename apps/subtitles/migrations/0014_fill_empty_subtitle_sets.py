...
class Migration(DataMigration):
    ...
    def backwards(self, orm):
        "Not going to bother, it would require us to loop through all versions setting an empty sub, no real point"
        pass
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 9, 34, 36, 203393)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 30, 9, 34, 36, 203288)'}),
