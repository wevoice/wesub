...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubtitleVersion.rollback_of_version_number'
        db.alter_column('subtitles_subtitleversion', 'rollback_of_version_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SubtitleVersion.rollback_of_version_number'
        db.alter_column('subtitles_subtitleversion', 'rollback_of_version_number', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 8, 34, 5, 834045)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 10, 16, 8, 34, 5, 833959)'}),
