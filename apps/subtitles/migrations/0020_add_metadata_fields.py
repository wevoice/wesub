...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubtitleVersion.meta_1_content'
        db.delete_column('subtitles_subtitleversion', 'meta_1_content')

        # Deleting field 'SubtitleVersion.meta_2_content'
        db.delete_column('subtitles_subtitleversion', 'meta_2_content')

        # Deleting field 'SubtitleVersion.meta_3_content'
        db.delete_column('subtitles_subtitleversion', 'meta_3_content')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 12, 5, 19, 129842)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 27, 12, 5, 19, 129746)'}),
