...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('subtitles_subtitlelanguage', 'subtitles_fetched_count')
    
    
    def backwards(self, orm):
        
        # Adding field 'SubtitleLanguage.subtitles_fetched_count'
        db.add_column('subtitles_subtitlelanguage', 'subtitles_fetched_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 23, 9, 33, 57, 425267)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 23, 9, 33, 57, 425131)'}),
