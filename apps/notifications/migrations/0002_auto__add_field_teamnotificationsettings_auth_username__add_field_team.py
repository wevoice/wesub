...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamNotificationSettings.auth_username'
        db.add_column('notifications_teamnotificationsettings', 'auth_username',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'TeamNotificationSettings.auth_password'
        db.add_column('notifications_teamnotificationsettings', 'auth_password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)

        # Adding field 'TeamNotificationSettings.header1'
        db.add_column('notifications_teamnotificationsettings', 'header1',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'TeamNotificationSettings.header2'
        db.add_column('notifications_teamnotificationsettings', 'header2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

        # Adding field 'TeamNotificationSettings.header3'
        db.add_column('notifications_teamnotificationsettings', 'header3',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'TeamNotificationSettings.auth_username'
        db.delete_column('notifications_teamnotificationsettings', 'auth_username')

        # Deleting field 'TeamNotificationSettings.auth_password'
        db.delete_column('notifications_teamnotificationsettings', 'auth_password')

        # Deleting field 'TeamNotificationSettings.header1'
        db.delete_column('notifications_teamnotificationsettings', 'header1')

        # Deleting field 'TeamNotificationSettings.header2'
        db.delete_column('notifications_teamnotificationsettings', 'header2')

        # Deleting field 'TeamNotificationSettings.header3'
        db.delete_column('notifications_teamnotificationsettings', 'header3')
