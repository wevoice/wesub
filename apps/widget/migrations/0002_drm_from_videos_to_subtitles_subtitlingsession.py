...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        '''
        Will nuke subtitling sessions, since it should be harmless except for people that will
        be during a subtitling session during the main migration, which will take hours anyways
        '''
        
        orm['widget.SubtitlingSession'].objects.all().delete()
        # Changing field 'SubtitlingSession.language'
        db.alter_column('widget_subtitlingsession', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleLanguage']))

        # Changing field 'SubtitlingSession.base_language'
        db.alter_column('widget_subtitlingsession', 'base_language_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['subtitles.SubtitleLanguage']))

        # Changing field 'SubtitlingSession.parent_version'
        db.alter_column('widget_subtitlingsession', 'parent_version_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['subtitles.SubtitleVersion'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SubtitlingSession.language'
        db.alter_column('widget_subtitlingsession', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage']))

        # Changing field 'SubtitlingSession.base_language'
        db.alter_column('widget_subtitlingsession', 'base_language_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['videos.SubtitleLanguage']))

        # Changing field 'SubtitlingSession.parent_version'
        db.alter_column('widget_subtitlingsession', 'parent_version_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleVersion'], null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 14, 21, 7, 749124)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 16, 14, 21, 7, 749016)'}),
        ...
        'widget.subtitlingsession': {
            ...
            'base_language': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'based_subtitling_sessions'", 'null': 'True', 'to': "orm['subtitles.SubtitleLanguage']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subtitling_sessions'", 'to': "orm['subtitles.SubtitleLanguage']"}),
            'parent_version': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['subtitles.SubtitleVersion']", 'null': 'True'}),
