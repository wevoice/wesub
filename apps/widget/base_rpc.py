...
class BaseRpc:
    def _make_subtitles_dict(self, subtitles, language_code, language_pk, is_original, is_complete, version, is_latest,  base_language, title, description, language_is_rtl, is_moderated):
        return {
            'subtitles': subtitles,
