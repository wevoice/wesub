...
def on_team_video_delete(sender, team, user, **kwargs):
    ActivityRecord.objects.create_for_video_moved(sender, from_team=team)
...
def on_video_moved_from_team_to_team(destination_team, old_team, video, **kwargs):
    ActivityRecord.objects.create_for_video_moved(video, from_team=old_team, to_team=destination_team)
