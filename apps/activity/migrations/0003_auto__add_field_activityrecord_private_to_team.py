...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ActivityRecord.private_to_team'
        db.add_column('activity_activityrecord', 'private_to_team',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ActivityRecord.private_to_team'
        db.delete_column('activity_activityrecord', 'private_to_team')
    ...
    models = {
        ...
        'activity.activityrecord': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 13, 0, 0)', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
